...
const Home: NextPage = () => {
  const ContactLinks = [
    {
      text: "My Website",
      link: "https://mariodev.vercel.app",
      svg: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="#fff"
          className={styles.links_button_icon}
        >
          <path
            fillRule="evenodd"
    ...
    {
      text: "Instagram",
      link: "https://instagram.com/meriofrog",
      svg: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="currentColor"
    ...
    {
      text: "Twitter",
      link: "https://twitter.com/JustNo29563283",
      svg: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="currentColor"
  ...
  return (
    ...
    >
      <div className={styles.header}>
        <img
          src="https://github.com/meriegg.png"
          title={"https://github.com/meriegg.png"}
          alt="Meriegg's Github Profile Picture"
          id="Profile Picture"
      ...
      <motion.div
        transition={{ staggerChildren: 0.2, delay: 0.5, duration: 0.2 }}
